...
namespace Eastcom.DAL
{
	...
	public partial class Sys_Power_UserRole
	{
        ...
        public int GetMaxId()
        {
            return DbHelperSQL.GetMaxID("Id", "Sys_Power_UserRole");
        }
        ...
        public bool Exists(int Id)
        {
            ...
            strSql.Append("select count(1) from Sys_Power_UserRole");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into Sys_Power_UserRole(");
            strSql.Append("FK_UserId,FK_RoleId,FK_EditID,EditTime,FK_CreateID,CreateTime)");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update Sys_Power_UserRole set ");
        ...
        public bool Delete(int Id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from Sys_Power_UserRole ");
            strSql.Append(" where Id=@Id");
            SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
        ...
        public Eastcom.Model.Sys_Power_UserRole GetModel(int Id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 Id,FK_UserId,FK_RoleId,FK_EditID,EditTime,FK_CreateID,CreateTime from Sys_Power_UserRole ");
            strSql.Append(" where Id=@Id");
            SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
            ...
            Eastcom.Model.Sys_Power_UserRole model = new Eastcom.Model.Sys_Power_UserRole();
        ...
        /// 得到一个对象实体
        /// </summary>
        public Eastcom.Model.Sys_Power_UserRole DataRowToModel(DataRow row)
        {
            Eastcom.Model.Sys_Power_UserRole model = new Eastcom.Model.Sys_Power_UserRole();
            if (row != null)
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select Id,FK_UserId,FK_RoleId,FK_EditID,EditTime,FK_CreateID,CreateTime ");
            strSql.Append(" FROM Sys_Power_UserRole ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" Id,FK_UserId,FK_RoleId,FK_EditID,EditTime,FK_CreateID,CreateTime ");
            strSql.Append(" FROM Sys_Power_UserRole ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from Sys_Power_UserRole T ");
        ...
        public DataSet GetList(int PageSize,int PageIndex,string strWhere)
        {
            ...
            parameters[0].Value = "Sys_Power_UserRole";
