...
namespace Eastcom.DAL
{
	...
	public partial class Sys_Power_RoleRight
	{
        ...
        public int GetMaxId()
        {
            return DbHelperSQL.GetMaxID("Id", "Sys_Power_RoleRight");
        }
        ...
        public bool Exists(int Id)
        {
            ...
            strSql.Append("select count(1) from Sys_Power_RoleRight");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into Sys_Power_RoleRight(");
            strSql.Append("FK_RoleId,FK_RightId,FK_EditID,EditTime,FK_CreateID,CreateTime)");
            strSql.Append(" values (");
            strSql.Append("@FK_RoleId,@FK_RightId,@FK_EditID,@EditTime,@FK_CreateID,@CreateTime)");
            strSql.Append(";select SCOPE_IDENTITY()");
            SqlParameter[] parameters = {
					new SqlParameter("@FK_RoleId", SqlDbType.Int,4),
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update Sys_Power_RoleRight set ");
        ...
        public bool Delete(int Id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from Sys_Power_RoleRight ");
            strSql.Append(" where Id=@Id");
            SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
        ...
        public Eastcom.Model.Sys_Power_RoleRight GetModel(int Id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 Id,FK_RoleId,FK_RightId,FK_EditID,EditTime,FK_CreateID,CreateTime from Sys_Power_RoleRight ");
            strSql.Append(" where Id=@Id");
            SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
            ...
            Eastcom.Model.Sys_Power_RoleRight model = new Eastcom.Model.Sys_Power_RoleRight();
        ...
        /// 得到一个对象实体
        /// </summary>
        public Eastcom.Model.Sys_Power_RoleRight DataRowToModel(DataRow row)
        {
            Eastcom.Model.Sys_Power_RoleRight model = new Eastcom.Model.Sys_Power_RoleRight();
            if (row != null)
            {
                ...
                if (row["FK_RoleId"] != null && row["FK_RoleId"].ToString() != "")
                {
                    model.FK_RoleId = int.Parse(row["FK_RoleId"].ToString());
                }
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select Id,FK_RoleId,FK_RightId,FK_EditID,EditTime,FK_CreateID,CreateTime ");
            strSql.Append(" FROM Sys_Power_RoleRight ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" Id,FK_RoleId,FK_RightId,FK_EditID,EditTime,FK_CreateID,CreateTime ");
            strSql.Append(" FROM Sys_Power_RoleRight ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from Sys_Power_RoleRight T ");
        ...
        public DataSet GetList(int PageSize,int PageIndex,string strWhere)
        {
            ...
            parameters[0].Value = "Sys_Power_RoleRight";
