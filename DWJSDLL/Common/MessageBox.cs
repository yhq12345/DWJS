...
namespace Eastcom.Common
{
	...
	{		
        ...
        public static void ShowAndJs(System.Web.UI.Page page, string msg,string JsMethod)
        {
            page.ClientScript.RegisterStartupScript(page.GetType(), "message", "<script language='javascript' defer>alert('" + msg.ToString() + "');" + JsMethod + "</script>");
		...
		{			
            ...
            page.ClientScript.RegisterStartupScript(page.GetType(), "message", "<script language='javascript' defer>alert('" + msg + "');parent.window.location=\"" + url + "\"</script>");
        ...
        /// <param name="msg">提示信息</param>
        /// <param name="url">跳转的目标URL</param>
        public static void ShowAndRedirectLocal(System.Web.UI.Page page, string msg, string url)
        {
