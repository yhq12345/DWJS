...
namespace Eastcom.BLL
{
    ...
    {
        private readonly Eastcom.DAL.考试题库_His dal = new Eastcom.DAL.考试题库_His();
        public 考试题库_His()
        { }
        #region  BasicMethod
        /// <summary>
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public Eastcom.Model.考试题库_His GetModelByCache(int id)
        {

            string CacheKey = "考试题库_HisModel-" + id;
            ...
            return (Eastcom.Model.考试题库_His)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<Eastcom.Model.考试题库_His> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<Eastcom.Model.考试题库_His> DataTableToList(DataTable dt)
        {
            List<Eastcom.Model.考试题库_His> modelList = new List<Eastcom.Model.考试题库_His>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                Eastcom.Model.考试题库_His model;
