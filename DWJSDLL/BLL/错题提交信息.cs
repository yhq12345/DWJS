...
namespace Eastcom.BLL
{
    ...
    {
        private readonly Eastcom.DAL.错题提交信息 dal = new Eastcom.DAL.错题提交信息();
        public 错题提交信息()
        { }
        #region  BasicMethod
        /// <summary>
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public Eastcom.Model.错题提交信息 GetModelByCache(int id)
        {

            string CacheKey = "错题提交信息Model-" + id;
            ...
            return (Eastcom.Model.错题提交信息)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<Eastcom.Model.错题提交信息> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<Eastcom.Model.错题提交信息> DataTableToList(DataTable dt)
        {
            List<Eastcom.Model.错题提交信息> modelList = new List<Eastcom.Model.错题提交信息>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                Eastcom.Model.错题提交信息 model;
