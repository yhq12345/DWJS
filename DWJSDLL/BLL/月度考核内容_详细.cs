...
namespace Eastcom.BLL
{
    ...
    {
        private readonly Eastcom.DAL.月度考核内容_详细 dal = new Eastcom.DAL.月度考核内容_详细();
        public 月度考核内容_详细()
        { }
        #region  BasicMethod
        /// <summary>
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public Eastcom.Model.月度考核内容_详细 GetModelByCache(int id)
        {

            string CacheKey = "月度考核内容_详细Model-" + id;
            ...
            return (Eastcom.Model.月度考核内容_详细)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<Eastcom.Model.月度考核内容_详细> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<Eastcom.Model.月度考核内容_详细> DataTableToList(DataTable dt)
        {
            List<Eastcom.Model.月度考核内容_详细> modelList = new List<Eastcom.Model.月度考核内容_详细>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                Eastcom.Model.月度考核内容_详细 model;
        ...
        {
            return dal.GetUndoneId(FK_月度考核);
        }
