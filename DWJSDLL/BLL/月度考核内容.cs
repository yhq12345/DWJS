...
namespace Eastcom.BLL
{
    ...
    {
        private readonly Eastcom.DAL.月度考核内容 dal = new Eastcom.DAL.月度考核内容();
        public 月度考核内容()
        { }
        #region  BasicMethod
        /// <summary>
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public Eastcom.Model.月度考核内容 GetModelByCache(int id)
        {

            string CacheKey = "月度考核内容Model-" + id;
            ...
            return (Eastcom.Model.月度考核内容)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<Eastcom.Model.月度考核内容> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<Eastcom.Model.月度考核内容> DataTableToList(DataTable dt)
        {
            List<Eastcom.Model.月度考核内容> modelList = new List<Eastcom.Model.月度考核内容>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                Eastcom.Model.月度考核内容 model;
        ...
        public bool Exists_Checked(string year, string month, string FK_ID)
        {
            return dal.Exists_Checked(year, month, FK_ID);
        }
        /// <summary>
        /// 
        /// </summary>
        ...
        {
            return dal.GetModelByUser(FK_User, 考核月份);
        }
