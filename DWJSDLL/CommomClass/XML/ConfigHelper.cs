...
namespace CommonClass.XML
{
    ...
    public sealed class ConfigClass
    {
        ...
        public static string GetConfigString(string SectionName, string key)
        {
            ...
            {
                System.Collections.Specialized.NameValueCollection cfgName = (System.Collections.Specialized.NameValueCollection)System.Configuration.ConfigurationManager.GetSection("appSettings");
