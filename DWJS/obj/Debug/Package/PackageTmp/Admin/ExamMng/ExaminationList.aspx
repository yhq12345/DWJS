<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExaminationList.aspx.cs"
    Inherits="DWKS.Admin.ExaminationList" %>
...
<body style="padding: 0px; text-align: center;">
    ...
    <div style="margin-left: 10px;" class="" id="mainsearch">
        ...
        <div class="searchbox">
            <ul>
                <li style="width: 90px; text-align: left;">查询月份：</li>
                <li style="width: 200px; text-align: left;">
                    <div class="l-text" style="width: 178px;">
                        <asp:DropDownList ID="ddl_Year_Month" runat="server" />
                        <div class="l-text-l">
                        </div>
                        <div class="l-text-r">
                        </div>
            ...
            <ul>
                <li style="width: 90px; text-align: left;">提交情况:</li>
                <li style="width: 200px; text-align: left;">
                    <div class="" style="width: 178px;">
                        <asp:DropDownList ID="ddl_TJQK" runat="server" />
                        </asp:DropDownList>
                        <div class="l-text-l">
                        </div>
                        <div class="l-text-r">
            ...
            <ul>
                ...
                <li style="width: 200px; text-align: left;">
                    <div class="l-text" style="width: 178px;">
                        <input type="text" runat="server" id="txt_RNCIP" name="RNCIP" class="field l-text-field"
                            style="width: 174px;" />
                        <div class="l-text-l">
                        </div>
                        <div class="l-text-r">
        ...
        <div class="searchbox">
            <ul>
                ...
                <li style="width: 200px; text-align: left;">
                    <div class="l-text" style="width: 178px;">
                        <input type="text" runat="server" id="txt_RNCUserName" name="BSCUserName" class="field l-text-field"
                            style="width: 174px;" />
                        <div class="l-text-l">
                        </div>
                        <div class="l-text-r">
                            ...
                            <Columns>
                                <asp:TemplateColumn HeaderText="操作" HeaderStyle-Width="80px">
                                    <ItemTemplate>
                                        ...
                                        <a onclick="top.f_addTab('BSC_See'+<%#Eval("id") %>, 'BSC信息查看', '/Admin/ExamMng/BSCConfigMng/ExaminationDetail.aspx?type=see&id=<%#Eval("id") %>') ;">
                                            查看</a>
                                        <a onclick="top.f_addTab('BSC_Edit'+<%#Eval("id") %>, 'BSC信息修改', '/Admin/ExamMng/BSCConfigMng/ExaminationDetail.aspx?type=update&id=<%#Eval("id") %>') ;">
                                ...
                                <asp:BoundColumn DataField="代维人员姓名" HeaderText="用户名"></asp:BoundColumn>
                                <asp:BoundColumn DataField="月份" HeaderText="月份" DataFormatString="{0:yyyy-MM}"></asp:BoundColumn>
                                <asp:BoundColumn DataField="考务生成时间" HeaderText="考务生成时间" DataFormatString="{0:yyyy-MM}"></asp:BoundColumn>
                                <asp:BoundColumn DataField="提交时间" HeaderText="提交时间" DataFormatString="{0:d}"></asp:BoundColumn>
                                <asp:BoundColumn DataField="回答情况" HeaderText="回答情况"></asp:BoundColumn>
                                <asp:BoundColumn DataField="得分" HeaderText="得分"></asp:BoundColumn>
                                <asp:BoundColumn DataField="提交情况" HeaderText="提交情况"></asp:BoundColumn>
                            </Columns>
                        </asp:DataGrid>
                    </div>
                </div>
