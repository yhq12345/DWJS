<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyAsk.aspx.cs" Inherits="DWKS.ASK.MyAsk" %>
    ...
    <script type="text/javascript">
        ...
        var funs = {
            ...
            sFunction_Next: function (str) {
                window.location.href = './MyAsk.aspx?id=<%=nextid %>';
            },
            sFunction_Pre: function (str) {
                window.location.href = './MyAsk.aspx?id=<%=preid %>';
            },
            sFunction_UnDone: function (str) {
                ...
                if (c == "0") {
                    ...
                    window.location.href = './MyAsk.aspx?id=' + c + '';
                }
            },
            sFunction_Submit: function (str) {
                art.dialog({ content: "提交成功!" });
                window.location.href = './MyIndex.aspx'; //返回欢迎页
            }
