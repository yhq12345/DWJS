...
{
    public partial class MyAskTEST : PageBase
    {
        public string TitleNo = "";

        public int maxNo = 100;
        public int MyDateNo = 0;
        ...
        /// <returns></returns>
        private string CommonModel(Eastcom.Model.日度练习考核内容_详细 model)
        {
        ...
        {
            Eastcom.Model.日度练习考核内容_详细 model2 = new Eastcom.Model.日度练习考核内容_详细();
            if (FK_YDKHNR != "")
            {
                model2 = new Eastcom.BLL.日度练习考核内容_详细().GetModelByBH_YD(CommonClass.StringHander.Common.GetInt(FK_YDKHNR), CommonClass.StringHander.Common.GetInt(id, 0));
                if (model2 == null)
                {
                    throw new Exception("对不起,你未生成考题或输入错误的题目序号,请刷新!");
                }
                else
                {
            ...
            if (题目编号 != "")
            {
                ...
                hid_AnSwer.Value = model2.标准答案_原;
                
                //}
            }
            else
            {
                throw new Exception("您未生成考题.");
            }
            SetBindBtn();
        }
        /// <summary>
        ...
        private void SetBindBtn()
        {
            ...
            switch (id)
            {
                ...
                case "100": next_btn.Disabled = true; break;
            }
        }
