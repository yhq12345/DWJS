...
namespace Eastcom
{
    public class BindView
    {
        ...
        public void Bind(string tbname, string FieldKey, int PageCurrent, int PageSize, string FieldShow, string FieldOrder, string Where, out int PageCount, System.Web.UI.WebControls.DataGrid grid, Label lbpagecount, Label lbcurpage)
        {
        ...
        public void Bind_ConnectionString2(string tbname, string FieldKey, int PageCurrent, int PageSize, string FieldShow, string FieldOrder, string Where, out int PageCount, System.Web.UI.WebControls.DataGrid grid, Label lbpagecount, Label lbcurpage)
        {

            string strconn = System.Configuration.ConfigurationManager.AppSettings["ConnectionString2"];
        ...
        public static void ResetGridView(DataGrid gridview)
        {
            //如果数据为空则重新构造Gridview
            if (gridview.Items.Count == 1 && gridview.Items[0].Cells[0].Text == EmptyText)
            {
                ...
                gridview.Items[0].Cells[0].Text = EmptyText;
                gridview.Items[0].Cells[0].Style.Add("text-align", "center");
            }
        }
        ...
        public static void GridViewDataBind(DataGrid gridview, DataTable table)
        {
            //记录为空重新构造Gridview
