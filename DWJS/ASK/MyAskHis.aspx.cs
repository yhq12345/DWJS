...
namespace DWKS.ASK
{
    public partial class MyAskHis : PageBase
    {
                    ...
                    else
                    {
                        foreach (Eastcom.Model.月度考核内容_详细 m in ModelList)
                        {
                            ...
                            if (m != null)
                            {
                                ...
                                c = c.Get用户得分情况(用户答案, m.标准答案_原.Trim());
                                m.得分 = c.用户得分;
                                m.回答情况 = c.得分情况;
        ...
        private string CommonModel(Eastcom.Model.月度考核内容_详细 model)
        {
            ...
            model.用户答案 = 我的选项_A + "," + 我的选项_B + "," + 我的选项_C + "," + 我的选项_D;
            model.回答情况 = "";
            model.得分 = 0;
